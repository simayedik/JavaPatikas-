package javaPratikleri.ÖgrenciBilgi;
...
public class Student {
    ...
    public void calcAvarage() {
        this.avarage = ((this.fizik.note*0.8 + this.fizik.verbalNote*0.2 ) + (this.kimya.note * 0.8 + this.kimya.verbalNote * 0.2) + (this.mat.note * 0.8 + this.mat.verbalNote * 0.2) ) / 3;
    }
